...
export const metadata: Metadata = pageMetadata({
  ...
  socialTitle: 'Terms of Service — Flori-Core',
  description: 'The terms governing use of Flori-Core Enterprise OS, including licensing, acceptable use, data ownership and service availability.',
  path: '/terms',
});
...
const structuredData = graph([
  webPage({
    path: '/terms',
    name: 'Terms of service — Flori-Core Enterprise OS',
    description: 'The terms governing use of Flori-Core Enterprise OS, including licensing, acceptable use, data ownership and service availability.',
  }),
  breadcrumbs([
    { name: 'Home', path: '/' },
